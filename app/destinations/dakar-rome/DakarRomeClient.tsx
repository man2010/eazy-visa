// app/destinations/dakar-rome/DakarRomeClient.tsx
'use client';
...
export default function DakarRomeClient() {
  ...
  // Valeurs par défaut – pré-rempli Dakar → Rome
  const defaultFlightData = {
    from: 'DSS - Blaise Diagne International Airport',
    to: 'FCO - Rome Fiumicino Airport',
  ...
  const handleSearch = (data = defaultFlightData) => {
    ...
    toast.success('Recherche lancée !', {
      description: 'Chargement des vols disponibles Dakar → Rome...',
    });
  };

  // Images pour le HeroCarousel – ambiance Rome / Italie
  const heroImages = [
    'https://images.unsplash.com/photo-1552832230-c0197dd311b5?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80', // Colisée au coucher du soleil
    'https://images.unsplash.com/photo-1525874684015-0241eb8e1974?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80', // Fontaine de Trevi
    'https://images.unsplash.com/photo-1515542622106-78bda8ba0d4f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80', // Place d’Espagne
    'https://images.unsplash.com/photo-1551896345-4b2d0e0d3e0d?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80', // Vatican & Basilique Saint-Pierre
    'https://images.unsplash.com/photo-1515542622106-78bda8ba0d4f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80', // Vue panoramique Rome
  ];

  const flightInfos = [
    { title: 'Durée moyenne', value: '6h – 8h (avec escale)', icon: Clock },
    { title: 'Prix dès', value: '350 000 FCFA', icon: MapPin },
    { title: 'Compagnies principales', value: 'ITA Airways, TAP Air Portugal, Air France, Turkish Airlines', icon: Plane },
  ...
  const testimonials = [
    {
      name: 'Aïssatou Barry',
      role: 'Étudiante en Italie',
      content:
        'Billet aller-retour Dakar-Rome pour 680 000 FCFA avec TAP via Lisbonne. Paiement Orange Money en 3 fois. L’équipe m’a beaucoup aidée pour le visa Schengen. Merci !',
    ...
    },
    {
      ...
      role: 'Commerçant',
      content:
        'Je voyage régulièrement vers Rome pour mes affaires. Les prix sont toujours très corrects et le service est rapide et fiable. Je recommande Eazy-Visa.',
  ...
  const faqItems = [
    {
      question: 'Y a-t-il des vols directs Dakar-Rome ?',
      answer:
        'Non, actuellement pas de vol direct. Les meilleures options passent par Lisbonne (TAP Air Portugal), Paris (Air France) ou Istanbul (Turkish Airlines). Durée totale entre 6h et 8h selon l’escale.',
    },
    {
      question: 'Faut-il un visa pour l’Italie depuis le Sénégal ?',
      answer:
        'Oui, un visa Schengen est requis pour les courts séjours. Nous pouvons vous orienter vers les démarches ou vous accompagner pour la prise de rendez-vous au centre VFS.',
    },
    {
      question: 'Quand réserver pour obtenir le meilleur prix ?',
      answer:
        'Idéalement 2 à 4 mois à l’avance. Les mois de janvier à mars et septembre à novembre sont souvent les plus avantageux.',
    },
    {
      question: 'Comment recevoir mon billet électronique ?',
      answer:
        'Immédiatement après paiement : e-ticket + instructions envoyés par email et WhatsApp. Possibilité de passer en agence pour une version papier si besoin.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">Vols Dakar - Rome</h1>
        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 md:mb-16">
          Trouvez les meilleurs vols Dakar - Rome avec Eazy-Visa. Des tarifs compétitifs, des compagnies aériennes fiables, et un service client 24/7.
        </p>
      ...
      <section className="bg-gradient-to-br from-[#A11C1C]/5 to-[#f8f1f1] py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Pourquoi réserver Dakar-Rome avec Eazy-Visa ?
          </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
          Nos voyageurs vers Rome témoignent
        </h2>
      ...
      <section className="bg-gray-100 py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Questions fréquentes – Vols Dakar Rome
          </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-24 text-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Prêt à découvrir Rome ?
          </h2>
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95">
            Meilleurs tarifs ITA Airways / TAP, paiement local, assistance 24/7
          </p>
