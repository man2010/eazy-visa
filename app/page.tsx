...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://eazy-visa.com',
    languages: {
      'fr-SN': 'https://eazy-visa.com',
      'fr-FR': 'https://eazy-visa.com',
    },
  },
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://eazy-visa.com/og-image-home.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://eazy-visa.com/og-image-home.jpg'],
  },
...
const jsonLd = {
  ...
  '@type': 'WebPage',
  '@id': 'https://eazy-visa.com/#webpage',
  'url': 'https://eazy-visa.com',
  ...
  'inLanguage': 'fr-SN',
  'isPartOf': {
    '@id': 'https://eazy-visa.com/#website'
  },
  'about': {
  ...
  'potentialAction': {
    ...
    'target': {
      '@type': 'EntryPoint',
      'urlTemplate': 'https://eazy-visa.com/recherche?query={search_term_string}'
    },
