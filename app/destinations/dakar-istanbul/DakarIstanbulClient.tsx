// app/destinations/dakar-istanbul/DakarIstanbulClient.tsx
'use client';
...
export default function DakarIstanbulClient() {
  // ── Dates helpers ─────────────────────────────────────────────────────────
  ...
  const handleSearch = () => {
    ...
    toast.success('Recherche lancée !', { description: 'Chargement des vols disponibles Dakar → Istanbul...' });
  };

  // ── Static content (unchanged) ─────────────────────────────────────────────
  const heroImages = [
    'https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80',
  ];

  const flightInfos = [
    { title: 'Durée moyenne', value: '6h – 7h30', icon: Clock },
    { title: 'Prix dès', value: '350 000 FCFA', icon: MapPin },
    { title: 'Compagnies principales', value: 'Turkish Airlines, Royal Air Maroc (via Casablanca)', icon: Plane },
  ...
  const advantages = [
    {
      icon: ShieldCheck,
      title: 'Réservation 100% sécurisée',
      desc: 'Confirmation immédiate – e-ticket envoyé par email & WhatsApp',
    },
    {
      icon: Users,
      title: 'Support sénégalais 24/7',
      desc: 'Équipe à Dakar – appel, WhatsApp ou visite en agence Keur Gorgui',
    },
    {
      icon: Star,
  ...
  const testimonials = [
    {
      ...
      role: 'Entrepreneuse',
      content:
        'Vol aller-retour Dakar-Istanbul pour 720 000 FCFA TTC avec Turkish Airlines. Paiement en 3 fois via Wave. Service parfait, merci Eazy-Visa !',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop',
    },
    {
      name: 'Ibrahima Ndao',
      role: 'Commerçant import-export',
      content:
        'Je voyage souvent vers la Turquie. Les prix sont toujours compétitifs et l\'équipe m\'aide pour les bagages en soute supplémentaires. Très satisfait.',
  ...
  const faqItems = [
    {
      question: 'Y a-t-il des vols directs Dakar-Istanbul ?',
      answer:
        'Oui, Turkish Airlines propose des vols directs depuis DSS (environ 6h). Sinon, possibilité d\'escales courtes via Casablanca ou Accra à prix souvent plus attractifs.',
    },
    {
      question: 'Faut-il un visa pour la Turquie depuis le Sénégal ?',
      answer:
        'Les citoyens sénégalais bénéficient d\'un e-Visa ou d\'une exemption selon la durée du séjour. Nous pouvons vous accompagner pour l\'obtention si besoin.',
    },
    {
      question: 'Quel est le meilleur moment pour réserver ce vol ?',
      answer:
        '2 à 3 mois à l\'avance pour les meilleurs tarifs. Évitez les périodes de fêtes musulmanes et fin d\'année si possible.',
    },
    {
      question: 'Comment recevoir mon billet électronique ?',
      answer:
        'Immédiatement après paiement : e-ticket + instructions par email et WhatsApp. Vous pouvez aussi passer en agence pour une copie papier.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-[#A11C1C] to-[#A11C1C] bg-clip-text text-transparent">
                Trouvez votre vol Dakar – Istanbul
              </h2>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div className="lg:col-span-1 relative">
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="di-departure-input">
                    Départ
                  </label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 pointer-events-none" />
                    <input
                      id="di-departure-input"
                      ref={fromInputRef}
                      type="text"
                ...
                {/* ── TO ── */}
                <div className="lg:col-span-1 relative">
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="di-arrival-input">
                    Arrivée
                  </label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 pointer-events-none" />
                    <input
                      ...
                      placeholder="Ex: Istanbul, Ankara…"
                      autoComplete="off"
                      className={`w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-[#A11C1C] focus:border-transparent transition-all ${
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">Vols Dakar - Istanbul</h1>
        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 md:mb-16">
          Trouvez les meilleurs vols Dakar - Istanbul avec Eazy-Visa. Des tarifs compétitifs, des compagnies aériennes fiables, et un service client 24/7.
        </p>
      ...
      <section className="bg-gradient-to-br from-[#A11C1C]/5 to-[#f8f1f1] py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Pourquoi choisir Eazy-Visa pour Dakar-Istanbul ?
          </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
          Nos voyageurs vers Istanbul témoignent
        </h2>
      ...
      <section className="bg-gray-100 py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Questions fréquentes – Vols Dakar Istanbul
          </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-24 text-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Envie de découvrir Istanbul ?
          </h2>
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95">
            Meilleurs tarifs Turkish Airlines, paiement local, assistance sénégalaise 24/7
          </p>
          <button
