/**
 * PAGE À PROPOS - CLIENT COMPONENT
 * Composant interactif avec animations et state
 */
...
export default function AProposClient() {
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 bg-gray-50">
      {/* Hero Carousel */}
      <section aria-label="Présentation Eazy-Visa">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Timeline */}
        <section className="mb-24" aria-labelledby="history-heading">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <h2 id="history-heading" className="text-4xl font-bold mb-4">Notre Histoire</h2>
          ...
          <div className="relative">
            <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-[#A11C1C] hidden lg:block" aria-hidden="true" />
        ...
        {/* Réalisations */}
        <section className="mb-24" aria-labelledby="achievements-heading">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-center mb-16"
          >
            <h2 id="achievements-heading" className="text-4xl font-bold mb-4">Nos Réalisations</h2>
        ...
        <section className="mb-24" aria-labelledby="team-heading">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 id="team-heading" className="text-4xl font-bold mb-4">Rencontrez Notre Équipe</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
