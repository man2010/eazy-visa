// app/destinations/dakar-montreal/DakarMontrealClient.tsx
'use client';
...
export default function DakarMontrealClient() {
  // ── Dates helpers ─────────────────────────────────────────────────────────
  ...
  const handleSearch = () => {
    ...
    toast.success('Recherche lancée !', { description: 'Chargement des vols disponibles Dakar → Montréal...' });
  };

  // ── Static content (unchanged) ─────────────────────────────────────────────
  const heroImages = [
    'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80',
    'https://images.unsplash.com/photo-1503614472-8c93d56e92ce?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80',
  ];

  const flightInfos = [
    { title: 'Durée moyenne', value: '10h – 14h (avec escale)', icon: Clock },
    { title: 'Prix dès', value: '600 000 FCFA', icon: MapPin },
    { title: 'Compagnies principales', value: 'Air Canada, Air France, TAP Air Portugal, Turkish Airlines', icon: Plane },
  ...
  const advantages = [
    ...
    {
      icon: Users,
      title: 'Support sénégalais 24/7',
      desc: 'Équipe à Dakar – appel, WhatsApp ou passage en agence Keur Gorgui',
    },
    {
      icon: Star,
  ...
  const testimonials = [
    {
      name: 'Aminata Sow',
      role: 'Étudiante au Québec',
      content:
        'J\'ai eu mon billet Dakar-Montréal pour 620 000 FCFA aller simple avec escale Paris. Paiement Wave en 3 fois. L\'équipe m\'a beaucoup aidée pour les documents. Merci !',
    ...
    },
    {
      ...
      role: 'Ingénieur',
      content:
        'Voyage professionnel régulier vers Montréal. Les prix sont compétitifs et le suivi est excellent. Je recommande Eazy-Visa sans hésiter.',
  ...
  const faqItems = [
    {
      question: 'Y a-t-il des vols directs Dakar-Montréal ?',
      answer:
        'Non, actuellement il n\'y a pas de vol direct. Les meilleures options passent par Paris (Air France), Lisbonne (TAP) ou Istanbul (Turkish Airlines). Durée totale entre 10h et 14h selon l\'escale.',
    },
    {
      question: 'Quel visa faut-il pour le Canada depuis le Sénégal ?',
      answer:
        'Un visa de visiteur (ou eTA selon le cas) est obligatoire. Nous pouvons vous accompagner pour la demande de visa canadien ou vous orienter vers les bons services.',
    },
    {
      question: 'Quand réserver pour obtenir le meilleur prix ?',
      answer:
        'Idéalement 3 à 6 mois à l\'avance. Les mois de janvier à mars et septembre à novembre sont souvent les moins chers.',
    },
    {
      question: 'Comment recevoir mon billet électronique ?',
      answer:
        'Immédiatement après paiement : e-ticket + instructions envoyés par email et WhatsApp. Vous pouvez aussi passer en agence pour une version imprimée.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-[#A11C1C] to-[#A11C1C] bg-clip-text text-transparent">
                Trouvez votre vol Dakar – Montréal
              </h2>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div className="lg:col-span-1 relative">
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="dmo-departure-input">
                    Départ
                  </label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 pointer-events-none" />
                    <input
                      id="dmo-departure-input"
                      ref={fromInputRef}
                      type="text"
                ...
                {/* ── TO ── */}
                <div className="lg:col-span-1 relative">
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="dmo-arrival-input">
                    Arrivée
                  </label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 pointer-events-none" />
                    <input
                      id="dmo-arrival-input"
                      ref={toInputRef}
                      type="text"
                      value={flightData.to}
                      onChange={(e) => {
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">Vols Dakar - Montréal</h1>
        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 md:mb-16">
          Trouvez les meilleurs vols Dakar - Montréal avec Eazy-Visa. Des tarifs compétitifs, des compagnies aériennes fiables, et un service client 24/7.
        </p>
      ...
      <section className="bg-gradient-to-br from-[#A11C1C]/5 to-[#f8f1f1] py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Pourquoi réserver Dakar-Montréal avec Eazy-Visa ?
          </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
          Nos voyageurs vers Montréal témoignent
        </h2>
      ...
      <section className="bg-gray-100 py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Questions fréquentes – Vols Dakar Montréal
          </h2>
