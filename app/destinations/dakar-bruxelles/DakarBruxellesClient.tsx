// app/destinations/dakar-bruxelles/DakarBruxellesClient.tsx
'use client';
...
export default function DakarBruxellesClient() {
  // ── Dates helpers ─────────────────────────────────────────────────────────
  ...
  const handleSearch = () => {
    ...
    toast.success('Recherche lancée !', { description: 'Chargement des vols disponibles Dakar → Bruxelles...' });
  };

  // ── Static content (unchanged) ─────────────────────────────────────────────
  const heroImages = [
    'https://images.unsplash.com/photo-1549823084-3c98cec07e39?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80',
  ];

  const flightInfos = [
    { title: 'Durée moyenne', value: '6h – 7h30 (avec escale)', icon: Clock },
    { title: 'Prix dès', value: '400 000 FCFA', icon: MapPin },
    { title: 'Compagnies principales', value: 'Brussels Airlines, Air France, TAP Air Portugal, Royal Air Maroc', icon: Plane },
  ...
  const testimonials = [
    {
      ...
      content:
        'Billet aller-retour Dakar-Bruxelles pour 780 000 FCFA avec Brussels Airlines. Paiement en 3 fois via Wave. L\'équipe m\'a accompagnée pour le visa étudiant. Service impeccable !',
    ...
    },
    {
      ...
      content:
        'Voyages fréquents vers Bruxelles pour le travail. Les prix restent très compétitifs et le suivi est toujours au top. Eazy-Visa est mon agence de confiance.',
  ...
  const faqItems = [
    {
      question: 'Y a-t-il des vols directs Dakar-Bruxelles ?',
      answer:
        'Oui, Brussels Airlines propose des vols directs plusieurs fois par semaine (environ 6h). Sinon, excellentes options avec escale courte via Paris ou Lisbonne.',
    },
    {
      question: 'Faut-il un visa pour la Belgique depuis le Sénégal ?',
      answer:
        'Oui, un visa Schengen est nécessaire pour les courts séjours. Nous pouvons vous orienter vers les démarches ou vous accompagner pour la prise de rendez-vous au centre VFS.',
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-[#A11C1C] to-[#A11C1C] bg-clip-text text-transparent">
                Trouvez votre vol Dakar – Bruxelles
              </h2>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div className="lg:col-span-1 relative">
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="db-departure-input">
                    Départ
                  </label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 pointer-events-none" />
                    <input
                      id="db-departure-input"
                      ref={fromInputRef}
                      type="text"
                ...
                {/* ── TO ── */}
                <div className="lg:col-span-1 relative">
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="db-arrival-input">
                    Arrivée
                  </label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 pointer-events-none" />
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">Vols Dakar - Bruxelles</h1>
        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 md:mb-16">
          Trouvez les meilleurs vols Dakar - Bruxelles avec Eazy-Visa. Des tarifs compétitifs, des compagnies aériennes fiables, et un service client 24/7.
        </p>
      ...
      <section className="bg-gradient-to-br from-[#A11C1C]/5 to-[#f8f1f1] py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Pourquoi réserver Dakar-Bruxelles avec Eazy-Visa ?
          </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
          Nos voyageurs vers Bruxelles témoignent
        </h2>
      ...
      <section className="bg-gray-100 py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Questions fréquentes – Vols Dakar Bruxelles
          </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-24 text-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Prêt à partir pour Bruxelles ?
          </h2>
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95">
            Vols Brussels Airlines, paiement local, assistance 24/7 – réservez maintenant !
          </p>
          <button
