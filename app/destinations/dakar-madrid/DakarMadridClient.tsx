// app/destinations/dakar-madrid/DakarMadridClient.tsx
'use client';
...
export default function DakarMadridClient() {
  // ── Dates helpers ─────────────────────────────────────────────────────────
  ...
  const handleSearch = () => {
    ...
    toast.success('Recherche lancée !', { description: 'Chargement des vols disponibles Dakar → Madrid...' });
  };
  ...
  const flightInfos = [
    { title: 'Durée moyenne', value: '5h – 7h (avec escale)', icon: Clock },
    { title: 'Prix dès', value: '300 000 FCFA', icon: MapPin },
    { title: 'Compagnies principales', value: 'Iberia, Air Europa, TAP Air Portugal, Royal Air Maroc', icon: Plane },
  ...
  const testimonials = [
    {
      name: 'Fatima Ndiaye',
      role: 'Étudiante en Espagne',
      content:
        'Billet aller-retour Dakar-Madrid pour 580 000 FCFA avec Iberia. Paiement Wave en 3 fois. L\'équipe m\'a aidée pour les documents d\'inscription. Service excellent !',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop',
    },
    {
      name: 'Youssoupha Gueye',
      role: 'Entrepreneur',
      content:
        'Je voyage souvent vers Madrid pour mes affaires. Les prix sont toujours compétitifs et le suivi est très professionnel. Je reste fidèle à Eazy-Visa.',
  ...
  const faqItems = [
    {
      question: 'Y a-t-il des vols directs Dakar-Madrid ?',
      answer:
        'Non, actuellement pas de vol direct. Les meilleures options passent par Lisbonne (TAP Air Portugal), Casablanca (Royal Air Maroc) ou Paris. Durée totale entre 5h et 7h selon l\'escale.',
    },
    {
      question: 'Faut-il un visa pour l\'Espagne depuis le Sénégal ?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Immédiatement après paiement : e-ticket + instructions envoyés par email et WhatsApp. Vous pouvez passer en agence pour une version papier si nécessaire.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-[#A11C1C] to-[#A11C1C] bg-clip-text text-transparent">
                Trouvez votre vol Dakar – Madrid
              </h2>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div className="lg:col-span-1 relative">
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="dm-departure-input">
                    Départ
                  </label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 pointer-events-none" />
                    <input
                      id="dm-departure-input"
                      ref={fromInputRef}
                      type="text"
                ...
                {/* ── TO ── */}
                <div className="lg:col-span-1 relative">
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2" htmlFor="dm-arrival-input">
                    Arrivée
                  </label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400 pointer-events-none" />
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">Vols Dakar - Madrid</h1>
        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 md:mb-16">
          Trouvez les meilleurs vols Dakar - Madrid avec Eazy-Visa. Des tarifs compétitifs, des compagnies aériennes fiables, et un service client 24/7.
        </p>
      ...
      <section className="bg-gradient-to-br from-[#A11C1C]/5 to-[#f8f1f1] py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Pourquoi réserver Dakar-Madrid avec Eazy-Visa ?
          </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
          Nos voyageurs vers Madrid témoignent
        </h2>
      ...
      <section className="bg-gray-100 py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 text-gray-800">
            Questions fréquentes – Vols Dakar Madrid
          </h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-24 text-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Prêt à découvrir Madrid ?
          </h2>
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95">
            Meilleurs tarifs Iberia/TAP, paiement local, assistance 24/7
          </p>
          <button
